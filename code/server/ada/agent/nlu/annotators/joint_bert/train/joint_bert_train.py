...
_MODEL_OUTPUT_PATH = "models/joint_bert_v1.1_all_topics"
_DATA_PATH = "data/nlu/annotated_examples_v1.1_clean.yaml"


class JointBERTTrain(JointBERTModel, pl.LightningModule):
    def __init__(
        self, intent_label_count: int, slot_label_count: int, **kwargs
    ) -> None:
        """Initializes the JointBERTModel training model.
    ...
    def save_pretrained(self, path: str) -> None:
        ...
        # Save metadata
        metadata = {
            "intents": [intent.name for intent in UserIntent],
...
if __name__ == "__main__":
    ...
    wandb_logger = WandbLogger(project="ADAJointBERT")
